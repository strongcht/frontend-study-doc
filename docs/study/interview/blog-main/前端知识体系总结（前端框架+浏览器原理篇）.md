...
![第4篇.png](../images/blog-main-browserl-01.png)
...
3） 当使用 v-deep 时 原理 `.foo ::v-deep(.bar) -> [xxxxxxx] .foo .bar`
例如：` [data-v-1542731c] .el-button.is-plain { } ` 当前组件中（带有 data-v-1542731c 属性）的 .el-button 元素，并且这个元素还必须同时具有 is-plain 类，应用样式规则
[参考](https://zhuanlan.zhihu.com/p/688510040)
...
[github issues Vue Router 原理](https://juejin.cn/post/6844904099050160141)
...
[github issues 关于 Vue 和 React 区别的一些笔记](https://github.com/lihongxun945/myblog/issues/21)
...
![nodeLoop.jpg](../images/blog-main-browserl-02.png)
...
![onion.png](../images/blog-main-browserl-03.png)
...
[XSS与CSRF攻击](https://coffe1891.gitbook.io/frontend-hard-mode-interview/1/1.5.5)
